  ...
  <div class="payload-grid">
    ...
    <div class="payload-card">
      ...
      <div class="payload-specs">
        <div class="spec-item"><div class="spec-label">Weight</div><div class="spec-val">70g / 2.5oz</div></div>
        <div class="spec-item"><div class="spec-label">Connections</div><div class="spec-val">USB-C + 2 modules</div></div>
        <div class="spec-item"><div class="spec-label">Mount time</div><div class="spec-val">5 seconds</div></div>
        <div class="spec-item"><div class="spec-label">IP Rating</div><div class="spec-val">IP54 equiv.</div></div>
      </div>
      </div>
    </div>
    ...
    <div class="payload-card">
      ...
      <div class="payload-specs">
        <div class="spec-item"><div class="spec-label">Lumens</div><div class="spec-val">20,000 (boost)</div></div>
        <div class="spec-item"><div class="spec-label">Colour</div><div class="spec-val">Cold white</div></div>
        <div class="spec-item"><div class="spec-label">Weight</div><div class="spec-val">150g / 5.3oz</div></div>
        <div class="spec-item"><div class="spec-label">Control</div><div class="spec-val">Remote adj.</div></div>
      </div>
      </div>
    </div>
    ...
    <div class="payload-card">
      ...
      <div class="payload-specs">
        <div class="spec-item"><div class="spec-label">Wavelength</div><div class="spec-val">750–940nm</div></div>
        <div class="spec-item"><div class="spec-label">Power</div><div class="spec-val">70W</div></div>
        <div class="spec-item"><div class="spec-label">Weight</div><div class="spec-val">150g / 5.3oz</div></div>
        <div class="spec-item"><div class="spec-label">Control</div><div class="spec-val">Remote adj.</div></div>
      </div>
      </div>
    ...
    <div class="payload-card">
      ...
      <div class="payload-specs">
        <div class="spec-item"><div class="spec-label">Weight</div><div class="spec-val">50g / 1.7oz</div></div>
        <div class="spec-item"><div class="spec-label">Interface</div><div class="spec-val">RC controlled</div></div>
        <div class="spec-item"><div class="spec-label">Safety</div><div class="spec-val">Multi-lock</div></div>
        <div class="spec-item"><div class="spec-label">Config</div><div class="spec-val">L+R pair</div></div>
      </div>
      </div>
    </div>
      ...
      <div class="use-cases-grid">
        ...
        <div class="use-case-card">
          <div class="use-case-icon-wrap" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>
          </div>
        ...
        <div class="use-case-card">
          <div class="use-case-icon-wrap" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="m12.83 2.18 8.58 4.88a1 1 0 0 1 0 1.74l-8.58 4.88a2 2 0 0 1-1.66 0L2.6 8.8a1 1 0 0 1 0-1.74l8.57-4.88a2 2 0 0 1 1.66 0Z"/><path d="m22 12.65-8.97 5.1a2 2 0 0 1-1.66 0L2.6 12.65"/><path d="m22 17.65-8.97 5.1a2 2 0 0 1-1.66 0L2.6 17.65"/></svg>
          </div>
...
<form id="tundraLeadForm" class="lead-form-card">
    ...
    <div class="form-group">
      ...
      <input type="text" name="full_name" placeholder="e.g. James Morton" required>
    </div>
    <div class="form-group">
